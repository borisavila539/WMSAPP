    ...
    try {
      await WmSApi.get<string>(`EnviarRecibirtraslado/${TRANSFERID}/${estado}`).then(resp => {
        if (resp.data == "OK") {
          ...
          if (estado == "ENVIAR" && WMSState.INVENTLOCATIONIDTO != "1" && WMSState.INVENTLOCATIONIDTO != "21" && WMSState.INVENTLOCATIONIDTO != "5") {
    ...
    return (
      <View style={{ width: '100%', alignItems: 'center' }}>
        <View style={{ backgroundColor: grey, width: '95%', borderRadius: 10, margin: 2, padding: 5, borderWidth: 2, borderColor: getColorEstado() }}>
          ...
          {
            (WMSState.INVENTLOCATIONIDTO == "1" || WMSState.INVENTLOCATIONIDTO == "21" || WMSState.INVENTLOCATIONIDTO == "5") &&
