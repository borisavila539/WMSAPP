...
type props = StackScreenProps<RootStackParams, "DiseñoEtiquetasEImpresionModule">
export const DiseñoEtiquetasEImpresionModule: FC<props> = ({ navigation }) => {
    const [data, setData] = useState<ScreensInterface[]>([])

    const setScreens = () => {
        let tmp: ScreensInterface[] = [
            { Name: ' Etiqueta Ubicación', Screen: 'DiseñoParaImprimirEtiquetasUbicacionScreen', image: require('../../../src/assets/EtiquetaUbicacion.png') },
        ]
        setData(tmp)
    }
    ...
    return (
        <View style={{ flex: 1, width: '100%', backgroundColor: grey }}>
            <Header texto1='' texto2='Menu de Diseño' texto3='' />
            <FlatList
                data={data}
