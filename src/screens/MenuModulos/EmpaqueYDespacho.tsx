...
type props = StackScreenProps<RootStackParams, "EmpaqueYDespachoScreen">
export const EmpaqueYDespachoScreen: FC<props> = ({ navigation }) => {
    ...
    const setScreens = () => {
        ...
        { Name: 'Reduccion Cajas', Screen: 'ReduccionCajasScreen', image: require('../../assets/AuditoriaImagen.png') },
         { Name: 'Tracking y Nanifiesto de cajas', Screen: 'DeclaracionEnvioScreen', image: require('../../assets/Packing.png') },
         { Name: 'Control tiempos Etiquetado', Screen: 'ControlCajaEtiquetasScreen', image: require('../../assets/AuditoriaImagen.png') }, 
        ]
        setData(tmp)
    }
