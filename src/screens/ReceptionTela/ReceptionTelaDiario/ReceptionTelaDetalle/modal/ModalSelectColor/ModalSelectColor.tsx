...
export const ModalSelectColor: FC<ModalSelectColorProps> = ({ isOpenModal, onClose, listColors, title }) => {
            ...
            renderItem={(item) =>
              ...
              >
                <View style={{ width: '100%', backgroundColor: !item.item.is_scanning ? orange : blue, borderRadius: 10, marginBottom: 5, padding: 5 }}>
                  ...
                  {item.item.location !== null && <Text style={{ color: grey }} >Ubicación: {item.item.location}</Text>}
