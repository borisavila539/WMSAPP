...
type props = StackScreenProps<RootStackParams, "ReduccionCajasScreen2">
2
export const ReduccionCajasScreen2: FC<props> = ({ navigation }) => {
        ...
        return (
            <View>
                <TouchableOpacity style={{ backgroundColor: orange, width: '90%', borderRadius: 10, paddingVertical: 8, alignItems: 'center' }}
                    ...
                    <Icon name='print' size={30} color={grey} />
